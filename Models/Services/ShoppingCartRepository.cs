...
namespace AnhBui.Models.Services
{
    ...
    {
        private AnhBuiDbContext dbContext;
        public List<ShoppingCartItem>? ShoppingCartItems { get; set; }
        public string? ShoppingCartId { set; get; }
        public ShoppingCartRepository(AnhBuiDbContext dbContext)
        {
        ...
        public static ShoppingCartRepository GetCart(IServiceProvider services)
        {
            ...
            AnhBuiDbContext context = services.GetService<AnhBuiDbContext>() ?? throw new Exception("Error initializing AnhBuidbcontext");
